...
function(GenerateWaylandExtensionFiles)
	...
	if(UNIX)
		...
		if(NOT FOUND_WAYLAND_GEN)
			...
			if(EXISTS "${XDG_SHELL_XML}" AND FOUND_WAYLAND_SCANNER)

				execute_process(
					COMMAND echo GENERATING WAYLAND EXTENSIONS
					COMMAND bash -c
					"wayland-scanner private-code <\"${XDG_SHELL_XML}\" >\"${CMAKE_SOURCE_DIR}/include/generated/xdg-shell.c\""
					COMMAND bash -c
					"wayland-scanner client-header <\"${XDG_SHELL_XML}\" >\"${CMAKE_SOURCE_DIR}/include/generated/xdg-shell.h\""
					RESULT_VARIABLE WAYLAND_GEN_OK
				)
